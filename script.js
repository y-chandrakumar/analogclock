...
document.getElementById('it').innerHTML=hour+":"+min+":"+sec+" "+pp;
}
...
function ani(){
    ...
    // let nom=abc.getSeconds()+29;
    // list[nom].style.backgroundColor="white";
    // list[nom-1].style.backgroundColor="transparent";
